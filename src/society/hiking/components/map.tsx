...
import { cn } from "#/society/shared/classNames";
...
function getDocumentTheme(): Theme | null {
	...
	const webtuiTheme = document.documentElement.dataset.webtuiTheme;
	if (
		webtuiTheme?.includes("dark") ||
		webtuiTheme === "nord" ||
		webtuiTheme === "osmium"
	)
		return "dark";
	if (webtuiTheme?.includes("light")) return "light";
...
function useResolvedTheme(themeProp?: "light" | "dark"): Theme {
	...
	useEffect(() => {
		...
		observer.observe(document.documentElement, {
			attributes: true,
			attributeFilter: ["class", "data-webtui-theme"],
		});
