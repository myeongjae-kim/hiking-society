import { AssociateFeedNotice } from '#/features/feed/components/AssociateFeedNotice';
import { ArticleDetailClient } from '#/features/article/components/ArticleDetailClient';
