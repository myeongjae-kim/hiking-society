            ...
            requestBody: {
                content: {
                    "application/json": {
                        body: string;
                        /** @default [] */
                        existingMedia?: components["schemas"]["ArticleMedia"][];
                        /** @default [] */
                        uploadedMedia?: {
                            byteSize: number;
                            contentType: string;
...
export interface components {
    schemas: {
        ...
        Article: {
            ...
            media: components["schemas"]["ArticleMedia"][];
            updatedAt: string;
        };
        ArticleMedia: {
            byteSize?: number;
        ...
        Notification: {
            ...
            readAt: string | null;
            /** @enum {string} */
            type: "article_created" | "article_comment" | "article_reply" | "comment_reply" | "article_like" | "comment_like";
        };
        MembersResponse: {
